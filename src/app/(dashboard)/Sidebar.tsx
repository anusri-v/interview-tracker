...
export default function Sidebar({
  ...
  const navItems = isAdmin
    ? [
        ...
        { href: `/admin/interviewers${campaignQuery}`, label: "Interviewers", icon: InterviewersIcon, match: (p: string) => p.startsWith("/admin/interviewers") },

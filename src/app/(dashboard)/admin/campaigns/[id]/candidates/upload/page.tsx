  ...
  return (
    <div className="max-w-lg space-y-4">
      ...
      <p className="text-sm text-foreground-secondary">
        ...
        <code className="bg-card px-1.5 py-0.5 rounded text-foreground">resume_link</code>,{" "}
        <code className="bg-card px-1.5 py-0.5 rounded text-foreground">current_role</code>. One candidate per row.
      </p>
